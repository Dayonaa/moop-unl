...
from moop.capturer import get_video_frame
from moop.utilities import resolve_relative_path, conditional_thread_semaphore
...
def get_face_analyser() -> Any:
    ...
    with conditional_thread_semaphore():
        if (
            ...
            or moop.globals.g_current_face_analysis
            != moop.globals.g_desired_face_analysis
        ):
            model_path = resolve_relative_path("..")
            # removed genderage
            allowed_modules = moop.globals.g_desired_face_analysis
            moop.globals.g_current_face_analysis = moop.globals.g_desired_face_analysis
            if moop.globals.CFG.force_cpu:
                ...
                FACE_ANALYSER = insightface.app.FaceAnalysis(
                    name="buffalo_l",
                    root=model_path,
                    providers=moop.globals.execution_providers,
                    allowed_modules=allowed_modules,
                )
            FACE_ANALYSER.prepare(
                ctx_id=0,
                det_size=(640, 640) if moop.globals.default_det_size else (320, 320),
            )
