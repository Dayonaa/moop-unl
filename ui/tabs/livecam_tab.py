...
def start_cam(
    ...
    from moop.virtualcam import start_virtual_cam
    from moop.utilities import convert_to_gradio

    moop.globals.selected_enhancer = enhancer
    moop.globals.blend_ratio = blend_ratio
    moop.globals.subsample_size = int(upscale[:3])
...
def stop_swap():
    from moop.virtualcam import stop_virtual_cam
